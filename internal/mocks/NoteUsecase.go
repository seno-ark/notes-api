...
// NoteUsecase is an autogenerated mock type for the NoteUsecase type
...
func (_m *NoteUsecase) DeleteNote(ctx context.Context, noteID string) error {
...
func (_m *NoteUsecase) GetNote(ctx context.Context, noteID string) (*entity.Note, error) {
	ret := _m.Called(ctx, noteID)
...
func (_m *NoteUsecase) GetNoteList(ctx context.Context, filter *entity.GetNoteListFilter) ([]*entity.Note, int64, error) {
...
// NewNoteUsecase creates a new instance of NoteUsecase. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewNoteUsecase(t interface {
	mock.TestingT
	Cleanup(func())
}) *NoteUsecase {
	mock := &NoteUsecase{}
